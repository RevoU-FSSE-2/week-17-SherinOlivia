...
describe('Test Profile Page Component', () => {
    it('Profile Title Renders Correctly',async () => {
        render(<BrowserRouter> <Profile username={user.username} email={user.email} /> </BrowserRouter>)
    ...
    it('Return Link Works Correctly', async () => {
        const { getByText } = render(<BrowserRouter><Profile username={user.username} email={user.email} /></BrowserRouter>);
